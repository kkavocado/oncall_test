...
<div class="printingWhole">
  <table width="100%" cellpadding="3px">
    <tr>
      <td width="1.5%">
        <img class="printing" src="Photo/print.png" />
      </td>
    ...
    <div class="middle">
      <table width="100%">
        ...
        <td width="70%">
          ...
          <!--the request-->
          <form action="ErrandServlet" method="post">
    ...
    <div>
      <table class="tableStyle" cellpadding="55px" width="100%">
        ...
        <%
          ...
          String sql;
          sql = "select post_id,first_name,title,content,type,poster_uid,users.id as user_id from post join users on post.poster_uid=users.id where status=0 and type='Errands';";
