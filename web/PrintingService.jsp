    ...
    <div>
      <table class="tableStyle" cellpadding="55px" width="100%">
        ...
        <%
          ...
          String sql;
          sql = "select post_id,first_name,title,content,type,poster_uid,users.id as user_id from post join users on post.poster_uid=users.id where status=0 and type='Printing';";
